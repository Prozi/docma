(function (t, e) {
    ...
    function p(t, e, a) {
        ...
        if ((x.setAttribute("class", "tippy-content"), m)) {
            ...
            m instanceof Element
                ...
                : ((x.innerHTML = document.querySelector(m).innerHTML),
                  (v = m)),
    ...
    function A(t, e) {
        ...
        return (
            (a ? e.contains(p) : e === p && "BODY" !== p.nodeName) &&
                (d = v(d, e)),
            d
        );
    }
            ...
            handleTrigger: function (e) {
                if (t.state.enabled) {
                    var a =
                        ...
                        Wt.usingTouch &&
                        -1 <
                            ["mouseenter", "mouseover", "focus"].indexOf(
                                e.type,
                            );
    ...
    function Tt(t) {
        ...
        this.popperInstance
            ...
            e.appendTo.contains(this.popper) ||
                e.appendTo.appendChild(this.popper);
    }
    function Lt() {
        var t = this._(de),
            e = t.showTimeout,
    ...
    function Ot() {
        ...
        this._(de).followCursorListener = function (e) {
            if (
                !(
                    t._(de).lastTriggerEvent &&
                    "focus" === t._(de).lastTriggerEvent.type
                )
            ) {
            ...
            if (!(a && a._reference._tippy.options.interactive)) {
                if (e) {
                    ...
                    if (
                        ...
                        return Pt(e._tippy);
                    if (!0 !== i.hideOnClick || -1 < i.trigger.indexOf("click"))
                        return;
                }
                Pt();
            }
        ...
        ne = (function () {
            function t(e, a) {
                ...
                te(this, t),
                    ...
                    Object.keys(
                        ie({}, t.Defaults.modifiers, o.modifiers),
                    ).forEach(function (e) {
            ...
            modifiers: {
                ...
                arrow: {
                    ...
                    fn: function (t, e) {
                        ...
                        var i = e.element;
                        if ("string" == typeof i) {
                            if (((i = t.instance.popper.querySelector(i)), !i))
                                return t;
                        ...
                        var o = t.placement.split("-")[0],
                            ...
                            b = I(i)[l];
                        n[h] - b < p[c] &&
                            (t.offsets.popper[c] -= p[c] - (n[h] - b)),
                            n[c] + b > p[h] &&
                                (t.offsets.popper[c] += n[c] + b - p[h]),
                        ...
                        value: function (t) {
                            ...
                            if (!this.state.destroyed && this.state.enabled) {
                                ...
                                return o.dynamicTitle &&
                                    ...
                                    ? void 0
                                    : i.refObj ||
                                      document.documentElement.contains(i)
                                    ? void (o.onShow.call(a, this),
                                      (t = bt(
                                          void 0 === t ? o.duration : t,
                                          0,
                                      )),
                                      yt([a, n, s], 0),
                        ...
                        value: function (t) {
                            ...
                            if (!this.state.destroyed && this.state.enabled) {
                                ...
                                o.onHide.call(a, this),
                                    ...
                                    o.interactive &&
                                        i.classList.remove("tippy-active"),
                                    (a.style.visibility = "hidden"),
                                    (this.state.visible = !1),
                                    yt([p, n, n ? s : null], t),
                                    ut([p, n], "hidden"),
                                    o.interactive &&
                                        -1 < o.trigger.indexOf("click") &&
                                        gt(i),
                                    ft(function () {
                                        St.call(e, t, function () {
                                            e.state.visible ||
                            ...
                            if (!this.state.destroyed) {
                                ...
                                [
                                    ...
                                    this.options.target &&
                                        e &&
                                        a(
                                            this.reference.querySelectorAll(
                                                this.options.target,
                                            ),
                                        ).forEach(function (t) {
                                            return (
                                    ...
                                    this._(de).mutationObservers.forEach(
                                        function (t) {
                                            t.disconnect();
                                        },
                                    ),
