...
!(function (a, b) {
    ...
    function getTemplate(a, b) {
        if (a)
            return "function" == typeof a && a.template
                ? a.template
                : dust.isTemplateFn(a)
                  ? a
                  : b !== !1
    ...
    function mapThenable(a, b, c, d, e) {
    ...
    (dust.config = { whitespace: !1, amd: !1, cjs: !1, cache: !0 }),
        ...
        (dust.isEmpty = function (a) {
            return 0 !== a && (!(!dust.isArray(a) || a.length) || !a);
        }),
        ...
        (dust.isNonThenableFunction = function (a) {
            return "function" == typeof a && !dust.isThenable(a);
        }),
        ...
        (Context.wrap = function (a, b) {
            return dust.isContext(a)
                ? ((a.templateName = b), a)
                : new Context(a, {}, {}, null, b);
        }),
        ...
        (Context.prototype._get = function (a, b) {
            ...
            return dust.isNonThenableFunction(h)
                ? ((g = function () {
                      try {
        ...
        (Stream.prototype.emit = function (a, b) {
            ...
            for (f = f.slice(0), c = 0, d = f.length; c < d; c++) f[c](b);
            return !0;
        }),
        ...
        (Chunk.prototype.reference = function (a, b, c, d) {
            return dust.isNonThenableFunction(a)
                ? ((a = a.apply(b.current(), [
                      this,
                      b,
                      null,
        ...
        (Chunk.prototype.section = function (a, b, c, d) {
            var e,
                ...
                i = c["else"],
                j = this;
            if (dust.isNonThenableFunction(a) && !dust.isTemplateFn(a)) {
                try {
        ...
        (Chunk.prototype.exists = function (a, b, c) {
            var d = c.block,
                e = c["else"];
            if (dust.isThenable(a))
                return mapThenable(this, a, b, c, function (a, d) {
                    a.exists(d, b, c).end();
                });
            if (dust.isEmpty(a)) {
        ...
        (Chunk.prototype.await = function (a, b, c, d, e) {
            return mapThenable(this, a, b, c, function (a, f) {
                c ? a.section(f, b, c).end() : a.reference(f, b, d, e).end();
            });
        }),
        (Chunk.prototype.renderError = function (a, b, c) {
            var d = c && c.error;
            return d ? this.render(d, b.push(a)) : this;
        }),
        ...
        (s.emitEvent = function (e, t) {
            ...
            for (s in o)
                if (o.hasOwnProperty(s))
                    for (n = o[s].slice(0), i = 0; i < n.length; i++)
                        (r = n[i]),
...
(function (dust) {
    ...
    function body_2(chk, ctx) {
        return chk.w(
            '\n    <div class="container container-boxed">\n        <div id="docma-content"></div>\n        <br />\n        <hr />\n        <span class="docma-info"\n            >Documentation built with\n            <b\n                ><a\n                    target="_blank"\n                    rel="noopener noreferrer"\n                    href="https://onury.io/docma"\n                    >Docma</a\n                ></b\n            >.</span\n        >\n    </div>\n    ',
        );
    }
    body_2.__dustBody = !0;
    return body_0;
...
(function (dust) {
    ...
    function body_2(chk, ctx) {
        return chk
            .w("\n                \n                \n                ")
            .nx(ctx.get(["$constructor"], false), ctx, { block: body_3 }, {})
            .w("\n            ");
    }
    body_2.__dustBody = !0;
    function body_3(chk, ctx) {
        return chk
            .w('\n                    <p><b class="caption">Alias:</b> <code>')
...
(function (dust) {
    ...
    function body_3(chk, ctx) {
        return chk
            .w(
                '\n    <div class="sidebar-toolbar">\n        <div class="toolbar-scope-filters"></div>\n        <div class="toolbar-kind-filters"></div>\n        <div class="toolbar-buttons">\n            <span class="btn-switch-fold inline-block" title="Fold Symbols">\n                ',
            )
            .h(
                "eq",
                ctx,
            ...
            .w(
                '\n            </span>\n            <span\n                class="btn-switch-outline inline-block space-left-xs"\n                title="Toggle Outline"\n            >\n                ',
            )
            .h(
                "eq",
                ctx,
    ...
    function body_4(chk, ctx) {
        return chk.w(
            '\n                <i class="far fa-lg fa-caret-square-down"></i>\n                ',
        );
    }
    body_4.__dustBody = !0;
    function body_5(chk, ctx) {
        return chk.w(
            '\n                <i class="far fa-lg fa-caret-square-right"></i>\n                ',
        );
    }
    body_5.__dustBody = !0;
    function body_6(chk, ctx) {
        return chk.w(
            '\n                <i class="fas fa-lg fa-outdent"></i>\n                ',
        );
    }
    body_6.__dustBody = !0;
    function body_7(chk, ctx) {
        return chk.w(
            '\n                <i class="fas fa-lg fa-indent"></i>\n                ',
        );
    }
    body_7.__dustBody = !0;
    return body_0;
...
(function (dust) {
    ...
    function body_0(chk, ctx) {
        return chk
            .x(ctx.get(["properties"], false), ctx, { block: body_1 }, {})
            .w("\n");
    }
    body_0.__dustBody = !0;
    function body_1(chk, ctx) {
    ...
    function body_2(chk, ctx) {
        return chk
            .w(
                '\n\n<div class="space-top-sm space-bottom-xs fw-bold">Properties</div>\n<ul class="param-list">\n    ',
            )
    ...
    function body_3(chk, ctx) {
        return chk
            .w(
                '\n    <li>\n        <div class="param-meta clearfix">\n            <span class="inline-block space-right-sm">\n                <code>',
            )
...
(function (dust) {
    ...
    function body_0(chk, ctx) {
        return chk
            .x(ctx.get(["params"], false), ctx, { block: body_1 }, {})
            .w("\n");
    }
    body_0.__dustBody = !0;
    function body_1(chk, ctx) {
    ...
    function body_6(chk, ctx) {
        return chk.w(
            '\n                <span class="param-info required boxed">Required</span>\n                ',
        );
    }
    body_6.__dustBody = !0;
    function body_7(chk, ctx) {
        return chk
            .w(
                '\n                <span class="param-info default">Default:&nbsp;</span>\n                <code>',
            )
    ...
    function body_13(chk, ctx) {
        return chk
            .w(
                '\n                <span class="param-info default boxed">Default</span>\n                <span class="color-gray">:</span>\n                <code>',
            )
            .f(ctx.getPath(true, []), ctx, "h", ["$def"])
            .w("</code>\n                ");
    }
...
(function (dust) {
    ...
    function body_5(chk, ctx) {
        return chk
            .w(
                '\n        <div class="navbar-menu-btn" tabindex="0">\n            <i class="fas fa-lg fa-bars trans-all-ease"></i>\n            <i class="fas fa-md fa-times trans-all-ease"></i>\n        </div>\n        <div class="navbar-menu">\n            <ul class="navbar-list">\n                ',
            )
            .s(
    ...
    function body_8(chk, ctx) {
        return chk
            ...
            .f(ctx.get(["iconClass"], false), ctx, "h")
            .w('" aria-hidden="true"></i\n                        >')
            .x(ctx.get(["label"], false), ctx, { block: body_11 }, {})
            .x(ctx.get(["chevron"], false), ctx, { block: body_12 }, {})
            .w(
                "\n                    </a>\n                    <ul>\n                        ",
            )
            .s(ctx.get(["items"], false), ctx, { block: body_13 }, {})
            .w(
                "\n                    </ul>\n                </li>\n                ",
            );
    }
    ...
    function body_12(chk, ctx) {
        return chk.w(
            '<i\n                            class="nav-arrow fas fa-sm fa-angle-down"\n                        ></i\n                        >',
        );
    }
    body_12.__dustBody = !0;
    function body_13(chk, ctx) {
...
(function (dust) {
    ...
    function body_0(chk, ctx) {
        return chk
            .x(ctx.get(["$members"], false), ctx, { block: body_1 }, {})
            .w("\n");
    }
    body_0.__dustBody = !0;
    function body_1(chk, ctx) {
    ...
    function body_2(chk, ctx) {
        return chk
            .w(
                '\n\n<div class="space-top-sm space-bottom-xs fw-bold">Enumeration</div>\n<ul class="param-list">\n    ',
            )
    ...
    function body_3(chk, ctx) {
        return chk
            ...
            .f(ctx.getPath(true, []), ctx, "h", ["s", "$type"])
            .w(
                '</code>\n            </span>\n            <span class="param-info-box">\n                <span class="param-info value">Value:&nbsp;</span>\n                <code>',
            )
                ...
                documentation: [
                    {
                        ...
                        meta: {
                            ...
                            lineno: 48,
                            columnno: 0,
                            path: "/Users/JPI/projects/prozi/docma/src",
                            code: {
                                id: "astnode100000108",
                                name: "Docma",
                ...
                documentation: [
                    {
                        ...
                        meta: {
                            ...
                            lineno: 17,
                            columnno: 0,
                            path: "/Users/JPI/projects/prozi/docma/src/web",
                            code: {},
                        },
                        description:
                            "Docma (web) core.\n\n When you build the documentation with a template, `docma-web.js` will be\n generated (and linked in the main HTML); which is the core engine for the\n documentation web app. This will include everything the app needs such as\n the documentation data, compiled partials, dustjs engine, etc...\n\n <blockquote>An instance of this object is globally accessible within the generated SPA\n as <code>docma</code>. Note that the size of the `docma-web.js` script depends primarily\n on the generated documentation data.</blockquote>",
            ...
            !(function () {
                ...
                setTimeout(function () {
                    ...
                    if (c) {
                        ...
                        docma.log("Query-string:", e),
                            (a = e
                                ? docma.createRouteFromQuery(e)
